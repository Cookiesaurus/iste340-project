...
var data = {
    ...
    Thriller: ['Choose a Release Decade','--choose one--', '(TA) 1990s', '(TA) 2000s', '(TA) 2010s'],
...
function checkStorage() {
    ...
    if (GetCookie('prevChoices')) {
        ...
        previously = document.createElement('h3');
        previously.appendChild(document.createTextNode('Previously...'));
        prevDiv.appendChild(previously);

        youSelected = document.createElement('b');
        youSelected.appendChild(document.createTextNode('You selected:'));
        prevDiv.appendChild(youSelected);
        
        prevDiv.appendChild(document.createElement('br'));
        prevDiv.appendChild(document.createTextNode(getCookieVal(12)));
        prevDiv.appendChild(document.createElement('br'));
        prevDiv.appendChild(document.createElement('br'));

        recsWere = document.createElement('b');
        recsWere.appendChild(document.createTextNode('Your recommendations were:'));
        prevDiv.appendChild(recsWere);
        prevDiv.appendChild(document.createElement('br'));
